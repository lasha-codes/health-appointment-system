                ...
                <div className=''>
                  <div className='flex flex-col items-start gap-5'>
                    ...
                    <p className='text-[15px] max-w-[500px] text-gray-500'>
                      ...
                      Healthcare company, we would first like you to fill out
                      the form below this, after that we will receive your
                      information hiring manager will decide u will either be
                      acepted or not, if something goes wrong we can always
